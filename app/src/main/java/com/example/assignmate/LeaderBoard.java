...
import com.example.assignmate.adapters.rankAdapter;
...
public class LeaderBoard extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Streak Data");

        FirebaseRecyclerOptions<Streak_model> options = new FirebaseRecyclerOptions.Builder<Streak_model>().setQuery(databaseReference.orderByChild("longestStreakNeg").limitToFirst(10), Streak_model.class).build();
        ...
        ad = new rankAdapter(options,getContext());
